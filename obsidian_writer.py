...
DEFAULT_CATEGORIES = [
    ...
    {"name": "推理系统", "icon": "\ud83d\ude80", "keywords": ["batching", "scheduling", "serving system", "throughput optimization", "vllm", "trt-llm", "tensorrt", "llm serving", "inference engine", "disaggregated serving", "request scheduling", "slo latency", "inference framework", "serving architecture", "continuous batching", "llm inference", "inference optimization", "disaggregated inference", "disaggregated llm"]},
    {"name": "并行推理", "icon": "\ud83d\udd17", "keywords": ["parallel inference", "distributed inference", "pipeline parallel", "tensor parallel", "model parallelism", "disaggregated prefill", "prefill decode disaggregation", "sequence parallelism", "expert parallelism", "moe inference", "mixture-of-experts inference", "mixture-of-experts model", "routing-free moe", "expert routing"]},
